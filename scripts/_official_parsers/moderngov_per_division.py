...
# an <a href="mgUserInfo.aspx?..."> link to the councillor's bio page
# (Stockport, Lincoln, Crawley, Milton Keynes, and most non-WSC instances);
# the optional groups around the name capture either form.
